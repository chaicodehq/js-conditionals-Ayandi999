...
export function getWeatherAdvice(temperature, isRaining) {
  let advice=""
  if(temperature>=35) advice="Too hot for hiking - stay indoors and hydrate";
  else if(temperature>=25 && !isRaining) advice="Great weather for hiking - don't forget sunscreen"
  else if(temperature>=25 && isRaining) advice="Warm but rainy - consider indoor activities"
  else if(temperature>=15 && !isRaining) advice="Perfect hiking weather - enjoy the trails"
  else if(temperature>=15 && isRaining) advice="Cool and rainy - bring waterproof gear if hiking"
  else if(temperature>=5 && !isRaining) advice="Chilly - wear layers for your hike"
  else if(temperature>=5 && isRaining) advice="Cold and wet - best to stay indoors"
  else if(temperature<5) advice="Too cold - stay warm indoors"
